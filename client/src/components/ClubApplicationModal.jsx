...
const ClubApplicationModal = ({data, setShowModal}) => {
    console.log("check")
    return (
            ...
            <div className="bg-white rounded w-10/12">
                ...
                <div className="flex justify-between items-center w-full p-3">
                    <div>
                        ...
                        <button className="bg-white border border-red-500 hover:bg-red-500 hover:text-white rounded p-2 ml-2">불합격</button>
                    </div>
                    <div>
